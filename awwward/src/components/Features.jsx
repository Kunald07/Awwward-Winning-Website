    ...
    <section className='bg-black pb-52'>
        ...
        <div className="grid h-[135vh] grid-cols-2 gap-7">
            <div className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
                ...
                title={<>zig<b>m</b>a</>}
                description="A decentralized, open-source, and community-driven platform that allows you to create and share your own games."
                />
            </div>
            ...
            <div className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
                ...
                title={<>az<b>u</b>l</>}
                description="A cross-world metagame app, turning your activities across Web2 and Web3 games into a rewarding adventure."
                />
            </div>
